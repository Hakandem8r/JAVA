...
public class task1 {
    ...
    public static void main(String[] args) {
        ...
        //System.out.printf("Ortalama= %6.2f", OrtalamaBul(ogrenciler)); =>TODO "printf" virgülden sonrasını yazdırmak için..
    }
    ...
    public static void OrtalamaBul(ArrayList<Student> ogrenciler){
        ...
        System.out.println("Not ortalaması = " + toplam/ogrenciler.size());

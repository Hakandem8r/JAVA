...
public class Simple {
    ...
    public static void main(String[] args) {
        ...
        Simple.b=5;  // b değeri sınıfa ait olduğundan 1 tanedir ve değer atadıkça değişir
        Simple.b=7;

        ornek.increase(); //ornek.a   1 arttı, sınıfın da b si 1 arttı
        ornek2.increase(); // ornek2.a   1 arttı, sınıfın da b si 1 arttı

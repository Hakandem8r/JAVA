...
public class ifElse_String {
    public static void main(String[] args) {
       /* Sistem size "Bir String giriniz."   cümlesini versin.
        ...
        Daha sonra ilk stringi yazdırınız, altına da a karakterinden sonraki kısma sahip
        olan Stringi yazdırınız
 ...
 */
        ...
        if(text.contains("a")){
            String yeni = text.substring(text.indexOf("a")).toUpperCase();
            System.out.println("Yeni String = "+ yeni);
            System.out.println("Eski String = "+ yeni);

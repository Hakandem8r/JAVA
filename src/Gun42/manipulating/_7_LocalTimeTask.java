...
public class _7_LocalTimeTask {
    ...
    //      şu andaki zamana 1 saat ve 1 dakika ekleyerek sonucun saatini ve dakikasını ayrı ayrı test edin
    //2.test current time with minus minute and plus hour:
    //      şu andaki zamana 1 saat ve 1 dakika çıkartarak sonucun saatini ve dakikasını ayrı ayrı test edin

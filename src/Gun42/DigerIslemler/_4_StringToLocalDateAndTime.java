...
public class _4_StringToLocalDateAndTime {
    public static void main(String[] args) {
        ...
        System.out.println("tarih.format(format1) = " + tarih.format(format1));//İstediğimiz formatla yazdırdık

        String strTime="12:49";
        LocalTime time=LocalTime.parse(strTime);//parse ile String olan zaman bilgisi, LocalTime tipi gerçek
        System.out.println("time = " + time);//zaman değişkenine çevirdik
    }
}

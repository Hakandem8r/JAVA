...
public class _5_TestZamani {
    public static void main(String[] args) {
      ...
      //Which of the following can be inserted into the blank to create a date of June 21, 2014?
        LocalDate date=LocalDate.of(2014, Month.JUNE, 21); //todo CEVAP=> D, F

  //      A. new LocalDate(2014, 5, 21);
//        B. new LocalDate(2014, 6, 21);
//        C. LocalDate.of(2014, 5, 21);
//        D. LocalDate.of(2014, 6, 21);
//        E. LocalDate.of(2014, Calendar.JUNE, 21); // Calendar da olmaz çünkü 0'dan başlar, bu durumda 5 yani Mayıs'ı verir

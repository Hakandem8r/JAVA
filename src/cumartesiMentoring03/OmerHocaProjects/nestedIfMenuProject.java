...
public class nestedIfMenuProject {
    public static void main(String[] args) {
        /*
        Büfeden sipariş vereceksiniz.
        Double cuzdanim  oluşturun ve içerisinde 20 euro para olsun.
        Ve double toplamTutar oluşturun, her işlem sonrası artsın. (her siparişten sonra
        belirtilen fiyatı toplamTutara ekleyin!!
        ...
        Sistem bize "Ekstra Köfte İster misiniz ? (+1 Euro fark ile): (büyük küçük harf duyarlı
        olmaması için method kullanın)

        evet derse "2. köfte ekleniyor" mesajı gelsin.Altında da "Çift köfteli hamburgeriniz
        hazır !" yazsın.
        ...
        todo Eğer 2 yi seçerse,
         ...
         Evet derse, "2. peynir ekleniyor" mesajı, ve altına da "Çift peynirli Cheeseburgeriniz
         hazır! yazsın.
...
Eğer evet derse,"Normal ya da Zero ?(normal veya zero olarak cevaplayınız):" sorusunu sorsun.
 ...
 -TODO İPUCU -  Dummy kod eklemeniz gereken yerleri tespit edin ve boş Line ekleyin.
 (String bosLine = sc.nextLine();)
         */

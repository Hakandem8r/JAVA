...
public class switchSeyehatProject {
    /*
        bulundugunuz yerden, bir yere yolculuk edeceksiniz.

        1. Köln veya Frankfurta gidebilirsiniz.
        2. Bilet fiyatı hesabı = Her 20 Km başına 5 euro. örn: (100 km yol.
        Bilet parası =  (100/20)* 5 =25 euro
        3.Cüzdanınızda 100 euro olsun

todo İPUCU:  toplamTutar, işlem, FrankfurtKm, KmBirimFiyat   gibi sabit veri tipleri
 oluşturabilirsiniz. İşlemlerde direkt bunları cağırabilirsiniz.
   ...
   todo    Frankfurt girildiyse,
      ...
      "Rota = Köln" yazdırın.
       ...
       2.  Sistem bize "Kaç kişilik bilet istiyorsunuz? (Max 2 kişilik olabilir): "
       sorusunu sorsun.

...
public class atmSorusuSwitch {
    public static void main(String[] args) {
       ...
       2.Para yatırma derse, "ne kadar yatırmak istiyorsunuz?" sorusu gelsin. Bir değer girilsin
       ve yeni  bakiye yazdırılsın.
 ...
 */
        ...
        switch(islem){
            ...
            case 1:
                System.out.println("Bakiyeniz: "+ bakiye +" TL"); break;
            case 2:
            ...
            case 3:
                ...
                System.out.println("Yeni bakiye: " + bakiye + "Tl"); break;
            case 4:
                System.out.println("Sistemden çıkılıyor...."); break;
            default:

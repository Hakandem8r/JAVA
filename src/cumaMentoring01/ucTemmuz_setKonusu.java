...
public class ucTemmuz_setKonusu {
    ...
    adini toplaminiAl koyacagimiz ve parametre olarak bir String hashSet kabul edecek ayri bir
    method olusturarak hashSetin degerlerinin toplamini alacaksiniz.*/
